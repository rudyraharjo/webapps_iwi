<div id="modalContainer" class="modal fade" data-backdrop="static" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="formDesignation">
                <div class="modal-body">
                    {{ csrf_field() }}
                    <input type="hidden" name="designation_id" id="designation_id">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label>{{ __('configuration::module.designation.modal_input_name') }}:</label><span class="required text-danger">*</span>
                    ...
                    <div class="text-right">
                        <button type="button" class="btn btn-icon icon-left btn-light mr-2" tabindex="3"
                            ...
                            {{ __('configuration::module.designation.modal_btn_cancel') }}
                        </button>
