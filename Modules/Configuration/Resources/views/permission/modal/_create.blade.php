<div id="modalPermissionContainer" class="modal fade" data-backdrop="static" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="formPermission">
                <div class="modal-body">
                    {{ csrf_field() }}
                    <input type="hidden" name="permission_id" id="permission_id">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label>{{ __('configuration::module.permission.modal_input_name') }}:</label><span class="required text-danger">*</span>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label>{{ __('configuration::module.permission.modal_input_display_name') }}:</label>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label>{{ __('configuration::module.permission.modal_input_description') }}:</label>
                    ...
                    <div class="text-right">
                        <button type="button" class="btn btn-icon icon-left btn-light mr-2" tabindex="5"
                            ...
                            {{ __('configuration::module.permission.modal_btn_cancel') }}
                        </button>
