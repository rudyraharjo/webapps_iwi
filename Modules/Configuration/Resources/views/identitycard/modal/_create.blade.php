<div id="modalContainer" class="modal fade" data-backdrop="static" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="formIdentityCard">
                <div class="modal-body">
                    {{ csrf_field() }}
                    <input type="hidden" name="identitycard_id" id="identitycard_id">
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>{{ __('configuration::module.identitycard.modal_input_code') }}:</label><span class="required text-danger">*</span>
                            <input type="text" name="code" id="code" class="form-control" autofocus tabindex="1">
                            <span id="error-code" class="invalid-feedback"></span>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>{{ __('configuration::module.identitycard.modal_input_name') }}:</label><span class="required text-danger">*</span>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label>{{ __('configuration::module.identitycard.modal_input_description') }}:</label><span class="required text-danger">*</span>
                    ...
                    <div class="text-right">
                        <button type="button" class="btn btn-icon icon-left btn-light mr-2" tabindex="5"
                            ...
                            {{ __('configuration::module.identitycard.modal_btn_cancel') }}
                        </button>
